...
function addSwitcher() {
  ...
  if ($("#dzSwitcher").length == 0) {
    ...
    $(".sidebar-right-trigger,.sidebar-switcher-trigger").on(
      "click",
      function () {
...
(function ($) {
  ...
  versionSelect.on("change", function () {
    ...
    /* if(this.value === 'dark'){
			//jQuery(".nav-header .logo-abbr").attr("src", "./'+asset_base_url+'images/logo-white.png");
			jQuery(".nav-header .logo-compact").attr("src", "'+asset_base_url+'images/logo-text-white.png");
			jQuery(".nav-header .brand-title").attr("src", "'+asset_base_url+'images/logo-text-white.png");
			
			setCookie('logo_src', './'+asset_base_url+'images/logo-white.png');
			setCookie('logo_src2', ''+asset_base_url+'images/logo-text-white.png');
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", "./'+asset_base_url+'images/logo.png");
			jQuery(".nav-header .logo-compact").attr("src", "'+asset_base_url+'images/logo-text.png");
			jQuery(".nav-header .brand-title").attr("src", "'+asset_base_url+'images/logo-text.png");
			
			setCookie('logo_src', './'+asset_base_url+'images/logo.png');
			setCookie('logo_src2', ''+asset_base_url+'images/logo-text.png');
		} */
